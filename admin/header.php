                                    ...
                                    <li class="nk-menu-item">
                                        <a href="users" class="nk-menu-link">
                                            ...
                                            <span class="nk-menu-text">Create a user account</span><span
                                                class="nk-menu-badge badge-danger">Now</span>
                                        </a>
                                    </li><!-- .nk-menu-item -->
                                    <li class="nk-menu-heading">
                                    ...
                                    if ($crypto == 1) {
                                        ...
                                        <li class="nk-menu-item has-sub">
                                            ...
                                            <ul class="nk-menu-sub">
                                                <li class="nk-menu-item">
                                                    <a href="crypto" class="nk-menu-link"><span class="nk-menu-text">Crypto
                                                            Management</span></a>
                                                </li>
                                                <li class="nk-menu-item">
                                                    <a href="crypto?action=approved_deposits" class="nk-menu-link"><span
                                                            class="nk-menu-text">Approved Deposits</span></a>
                                                </li>
                                                <li class="nk-menu-item">
                                                    <a href="crypto?action=pending_deposits" class="nk-menu-link"><span
                                                            class="nk-menu-text">Pending Deposits <span
                                                                class="badge badge-primary"><?php $query = $conn->query("SELECT * FROM crypto_deposits WHERE status = 'pending'");
                                                                echo mysqli_num_rows($query); ?></span></span></a>
                                                </li>
                                                <li class="nk-menu-item">
                                                    <a href="crypto?action=rejected_deposits" class="nk-menu-link"><span
                                                            class="nk-menu-text">Rejected Deposits</span></a>
                                                </li>
                                                <li class="nk-menu-item">
                                                    <a href="crypto?action=withrawal_requests" class="nk-menu-link"><span
                                                            class="nk-menu-text">Withdrawal Requests <span
                                                                class="badge badge-primary"><?php $query = $conn->query("SELECT * FROM crypto_withdrawals WHERE status = 'pending'");
                                                                echo mysqli_num_rows($query); ?></span></span></a>
                                                </li>
                                            </ul><!-- .nk-menu-sub -->
                                        </li><!-- .nk-menu-item -->
                                            ...
                                            <div class="user-toggle">
                                                ...
                                                <div class="user-info d-none d-md-block">
                                                    ...
                                                    <div class="user-name dropdown-indicator">
                                                        <?php echo "$adfirstname $admiddlename $adlastname"; ?></div>
                                                </div>
                                            </div>
                                        </a>
                                        <div
                                            ...
                                            <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                                                <div class="user-card">
                                                    ...
                                                    <div class="user-info">
                                                        <span
                                                            class="lead-text"><?php echo "$adfirstname $admiddlename $adlastname"; ?></span>
                                            ...
                                            <div class="dropdown-inner">
                                                <ul class="link-list">
                                                    <li><a href="admin_profile"><em
                                                                ...
                                                                Profile</span></a></li>
                                                    <li><a href="admin_profile_setting"><em
                                                                class="icon ni ni-setting-alt"></em><span>Account
                                                                Setting</span></a></li>
                                                    <li><a href="admin_login_activities"><em
