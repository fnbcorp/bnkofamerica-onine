                            ...
                            <div class="card-inner-group" data-simplebar>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <ul class="link-list-opt no-bdr">
                                                        <li><a href="update_photo?id=<?php echo $id ?>"><em
                                ...
                                <div class="card-inner">
                                    <div class="user-account-info py-0">
                                        ...
                                        <div class="user-balance"><?php echo $accountbalance ?><small
                                                class="currency currency-btc"><?php echo $money ?></small>
                                        </div>
                                ...
                                <div class="card-inner p-0">
                                    <ul class="link-list-menu">
                                        ...
                                        <li><a class=""
                                                href="fund_user?accountnumber=<?php echo $accountnumber ?>&id=<?php echo $id ?>"><em
                                                    class="icon ni ni-wallet-in"></em><span>Credit Account</span></a>
                                        </li>
                                        <li><a class="" href="user_transaction?id=<?php echo $id ?>"><em
                                                    class="icon ni ni-tranx"></em><span>Transaction History</span></a>
                                        </li>

                                        <li><a class=""
                                                href="debit_user?accountnumber=<?php echo $accountnumber ?>&id=<?php echo $id ?>"><em
                                        ...
                                        <li><a href="user_activity?id=<?php echo $id ?>"><em
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="middlename" id="middlename"
                                            class="form-control form-control-lg" value="<?php echo $middlename ?>"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="lastname" id="lastname"
                                            class="form-control form-control-lg" value="<?php echo $lastname ?>"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg date-picker"
                                            value="<?php echo $dayOFBirth ?>" id="dob" name="dob">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="form-label" for="birth-day">Address</label>
                                        <input type="text" class="form-control form-control-lg " id="addressB"
                                            name="addressB" value="<?php echo $address ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                        <li>
                                            <button type="submit" class="btn btn-lg btn-primary userUpdate">Update
                                                Profile</button>
                                        </li>
                                        <li>
                            ...
                            <div class="row gy-4">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select type="text" class="form-control form-control-lg" id="accounttype"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="accountnumber"
                                            id="accountnumber" value="<?php echo $accountnumber ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="form-label" for="address-st">2FA pin</label>
                                        <input type="text" class="form-control form-control-lg" id="secretCode"
                                            name="secretCode" value="<?php echo $secretCode ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="form-label" for="address-st">Account Currency</label>
                                        <select type="text" class="form-control form-control-lg" id="usercurrency"
                                            name="usercurrency">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg" id="imf" name="imf"
                                            value="<?php echo $userimf ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="form-label" for="address-st">COT CODE</label>
                                        <input type="text" class="form-control form-control-lg" id="cot" name="cot"
                                            value="<?php echo $usercot ?>">
                                    </div>
                                </div>
                            </div>
                            <p></p>
