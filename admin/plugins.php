                ...
                <form action="#" class="gy-3">
                    <div class="row g-3 align-center">
                        <div class="col-lg-5">
                            <div class="form-group">
                                ...
                                <span class="form-note">Specify your tawk Property ID
                                    e.g(60d89fce7f4b000ac039dsc0/f6uyhb)</span>
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <div class="form-group">
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" id="tawk" value="<?php echo $tawk ?>"
                                        name="tawk">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row g-3 align-center">
                        ...
                        <div class="col-lg-7">
                            ...
                            <div class="form-group">
                                <div class="form-control-wrap">
                                    <select type="text" class="form-control form-control-xl" id="stockrate" value=""
                                        name="stockrate">
