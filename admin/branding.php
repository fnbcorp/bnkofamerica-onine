    ...
    <div class="nk-block nk-block-lg">
        ...
        <div class="card card-bordered">
            <div class="card-inner">
                ...
                <form action="../scripts/branding.php?action=logo" method="post" id="logoForm" class="gy-3"
                    ...
                    <div class="row g-3 align-center">
                        <div class="col-lg-5">
                            <div class="form-group">
                                ...
                                <span class="form-note">Logo should have a transparent background (300 x 82)
                                    recommended.</span>
                            </div>
                        </div>
                        <div class="col-lg-7">
        ...
        <div class="card card-bordered">
            <div class="card-inner">
                ...
                <form action="../scripts/branding.php?action=footerlogo" method="post" id="footerLogoForm" class="gy-3"
                    enctype="multipart/form-data">
                    <div class="row g-3 align-center">
                        <div class="col-lg-5">
                            <div class="form-group">
                                <label class="form-label" for="site-name">Footer Logo</label>
                                <span class="form-note">Specify the logo That will apear at the footer of your
                                    website</span>
                            </div>
                        </div>
                        <div class="col-lg-7">
                            ...
                            <div class="form-control-wrap" style="max-width: 300px;">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" name="footerlogo" accept="image/*"
                                        id="customFile">
                                    <label class="custom-file-label" for="customFile">Choose file</label>
                                </div>
                            </div>
        ...
        <div class="card card-bordered">
            <div class="card-inner">
                ...
                <form action="../scripts/branding.php?action=email" method="post" id="emailForm" class="gy-3"
                    enctype="multipart/form-data">
                    <div class="row g-3 align-center">
                        <div class="col-lg-5">
                            <div class="form-group">
                                ...
                                <span class="form-note">Specify the logo That will apear at the header of every outgoing
                                    email sent through your website. Should have light color and transparent
                                    background</span>
                            </div>
                        </div>
                        <div class="col-lg-7">
                            ...
                            <div class="form-control-wrap" style="max-width: 300px;">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" name="emaillogo" accept="image/*"
                                        id="customFile">
                                    <label class="custom-file-label" for="customFile">Choose file</label>
                                </div>
                            </div>
        ...
        <div class="card card-bordered">
            <div class="card-inner">
                ...
                <form action="../scripts/branding.php?action=favicon" method="post" id="faviconForm" class="gy-3"
                    enctype="multipart/form-data">
                    <div class="row g-3 align-center">
                        <div class="col-lg-5">
                            <div class="form-group">
                                <label class="form-label" for="site-name">Favicon</label>
                                <span class="form-note">Specify the favicon of your website. typically displayed in the
                                    address bar of a browser accessing the website or next to the website name in a
                                    user's list of bookmarks.</span>
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <div id="mainLogo">
                            ...
                            <div class="form-control-wrap" style="max-width: 300px;">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" name="favicon" accept="image/*"
                                        id="customFile">
                                    <label class="custom-file-label" for="customFile">Choose file</label>
                                </div>
                            </div>
