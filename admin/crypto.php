                ...
                <div class="nk-block-between-md g-4">
                    ...
                    <div class="nk-block-head-content">
                        <ul class="nk-block-tools gx-3">
                            <li><a href="users" class="btn btn-primary"><span>Back</span> <em
                                        class="icon ni ni-arrow-long-left"></em></a></li>
                        </ul>
                    </div>
                                    ...
                                    <div class="nk-wgw">
                                        <div class="nk-wgw-inner">
                                            ...
                                            <div class="nk-wgw-balance">
                                                <div class="amount"><?php echo $bal ?><span
                                                        class="currency currency-eth"><?php echo $r['code'] ?></span></div>
                                                <div class="amount-sm"><?php echo round($usd, 2) ?><span
                                                        class="currency currency-usd">USD</span></div>
                                            </div>
                                        </div>
                                        <div class="nk-wgw-actions">
                                            <ul>
                                                <li><button <?php echo $modal ?>
                                                        class="btn btn-sm btn-<?php echo $status ?>"><?php echo $eye ?>
                                                        <?php echo $txt ?></button></li>

                                                <li><button <?php echo "data-toggle='modal' data-target='#Update" . $coinid . "'";
                                                ?> class="btn btn-sm btn-primary"><em
                                                            class="icon ni ni-update"></em><span>Update Wallet</span></button>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="nk-wgw-more dropdown">
                                            <button type="submit"
                                                class="btn btn-icon btn-light"><?php echo $r['symbol'] ?></button>
                                        </div>
                                    </div>
                                </div><!-- .card -->
                            </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form action="" method="post">
                                        <input type="hidden" name="<?php echo $coin ?>" value="<?php echo $coin ?>"
                                            id="<?php echo $coin ?>">
                                        <button type="submit"
                                            class="btn btn-primary btn-sm closeBtn<?php echo $coinid ?>">Disable</button>
                    ...
                    <div class="modal fade" tabindex="-1" id="Enable<?php echo $coinid ?>">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <strong>You are about to Enable
                                        <?php echo $r['crypto_name'] ?>, Users will be able to deposit Crypto Using this
                                        Wallet henceforth!
                                    </strong>
                                </div>
                                ...
                                <div class="modal-footer">
                                    <form action="" method="post">
                                        <input type="hidden" name="<?php echo $coin ?>" value="<?php echo $coin ?>"
                                            id="<?php echo $coin ?>">
                                        <button type="submit"
                                            class="btn btn-primary btn-sm closeBtnB<?php echo $coinid ?>">Enable</button>
                                        <button class="btn btn-danger btn-sm" data-dismiss="modal">Cancel</button>
                                    </form>
                                </div>
                            </div>
                    ...
                    <div class="modal fade" tabindex="-1" id="Update<?php echo $coinid ?>">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <strong>You are about to Update
                                        <?php echo $r['crypto_name'] ?> Wallet Address for accepting Deposits.
                                    </strong>
                                </div>
                                <form action="" method="post">
                                    <div class="form-control-group p-2">
                                        <input type="text" class="form-control form-control-lg"
                                            name="wallet<?php echo $coinid ?>" id="wallet<?php echo $coinid ?>"
                                            value="<?php echo $r['address'] ?>">
                                        <div class="form-dropdown">
                                            <div class="text">
                                                <?php echo $coin ?><span></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit"
                                            class="btn btn-primary btn-sm UpdateBtn<?php echo $coinid ?>">Update</button>
                                        <button class="btn btn-danger btn-sm" data-dismiss="modal">Cancel</button>
                                </form>
                            </div>
                        </div>
                                    ...
                                    <tr class="nk-tb-item">
                                        ...
                                        <td class="nk-tb-col">
                                            <div class="user-card">
                                                ...
                                                <div class="user-info">
                                                    <span class="tb-lead"><?php echo $coindata['crypto_name'] ?><span
                                        ...
                                        <td class="nk-tb-col tb-col-mb" data-order="35040.34">
                                            <span
                                                class="tb-amount"><?php echo "" . $user['firstname'] . " " . $user['lastname'] . " " . $user['middlename'] . ""; ?></span>
                                        </td>
                                        <td class="nk-tb-col tb-col-mb" data-order="35040.34">
                                            <span class="tb-amount"><?php echo $coin ?> <span
                                                    class="currency"><?php echo $rows['amount'] ?></span></span>
                                        </td>
                                        ...
                                        <td class="nk-tb-col nk-tb-col-tools">
                                            <ul class="nk-tb-actions gx-1">
                                                ...
                                                <li class="nk-tb-action-hidden">
                                                    <a href="#" class="btn btn-trigger btn-icon" data-placement="top"
                                                        title="Reject" <?php echo "data-toggle='modal' data-target='#reject" . $id . "'"; ?>>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-header text-white"
                                            style="background-color:#033d75; color: white;">
                                            <h5 class="modal-title">Approve Deposit</h5>
                                        </div>
                                        <div class="modal-body">
                                            <strong>You are about to Approve
                                                <?php echo $rows['coin'];
                                                echo " ";
                                                echo $rows['amount'] ?> Deposit Made
                                                by
                                                <?php echo "" . $user['firstname'] . " " . $user['lastname'] . " " . $user['middlename'] . ""; ?>
                                            </strong>
                                        </div>
                                        <form action="" method="post">
                                            ...
                                            <div class="modal-footer">
                                                <input type="hidden" name="f<?php echo $id ?>" value="<?php echo $id ?>"
                                                    id="f<?php echo $id ?>">
                                                <button type="submit"
                                                    class="btn btn-primary btn-sm approveBtn<?php echo $id ?>">Approve</button>
                ...
                <div class="modal fade" tabindex="-1" id="reject<?php echo $id ?>">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <strong>You are about to Reject
                                    <?php echo $rows['coin'];
                                    echo " ";
                                    echo $rows['amount'] ?> Deposit Made by
                                    <?php echo "" . $user['firstname'] . " " . $user['lastname'] . " " . $user['middlename'] . ""; ?>
                                </strong>
                            </div>
                            <form action="" method="post">
                                ...
                                <div class="modal-footer">
                                    <input type="hidden" name="f<?php echo $id ?>" value="<?php echo $id ?>"
                                        id="f<?php echo $id ?>">
                                    <button type="submit"
                                        class="btn btn-primary btn-sm rejectBtn<?php echo $id ?>">Reject</button>
                                    <button class="btn btn-danger btn-sm" data-dismiss="modal">Cancel</button>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="modal fade" tabindex="-1" id="approve<?php echo $id ?>">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <strong>You are about to Delete
                                        <?php echo $rows['coin'];
                                        echo " ";
                                        echo $rows['amount'] ?> Deposit Made by
                                        <?php echo "" . $user['firstname'] . " " . $user['lastname'] . " " . $user['middlename'] . ""; ?>
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="modal-footer">
                                        <input type="hidden" name="f<?php echo $id ?>" value="<?php echo $id ?>"
                                            id="f<?php echo $id ?>">
                                        <button type="submit"
                                            class="btn btn-primary btn-sm approveBtn<?php echo $id ?>">Delete</button>
                                        <button class="btn btn-danger btn-sm" data-dismiss="modal">Cancel</button>
                                </form>
                            </div>
                        </div>
                ...
                <tbody>
                    ...
                    while ($rows = mysqli_fetch_array($query)) {
                        ...
                        <tr class="nk-tb-item">
                            ...
                            <td class="nk-tb-col tb-col-mb" data-order="35040.34">
                                <span class="tb-amount"><?php echo $money ?> <span
                                        class="currency"><?php echo $rows['amount'] ?></span></span>
                            </td>
                            <td class="nk-tb-col tb-col-md">
                                <span><?php echo $rows['datecreated'] ?></span>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <strong>You are about to Approve
                                    <?php echo $money;
                                    echo " ";
                                    echo $rows['amount'] ?> Withdrawal request Made by
                                    <?php echo "" . $user['firstname'] . " " . $user['lastname'] . " " . $user['middlename'] . ""; ?>
                                </strong>
                            </div>
                            <form action="" method="post">
