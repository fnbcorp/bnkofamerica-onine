        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="accountnumber" value="<?php echo randomNumber(10) ?>"
                name="accountnumber">
            </div>
          </div>
          <div class="col-md-4">
      ...
      $('.regUser').click(function (e) {
        ...
        $.ajax
          ({
            ...
            data: {
              "firstname": firstname, "middlename": middlename, "lastname": lastname, "countryId": countryId, "stateId": stateId, "cityId": cityId, "zipcode": zipcode,
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
<script
  src="https://www.jqueryscript.net/demo/jQuery-International-Telephone-Input-With-Flags-Dial-Codes/build/js/intlTelInput.js"></script>
<script>
  $("#phone").intlTelInput({
