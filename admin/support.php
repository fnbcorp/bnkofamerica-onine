        ...
        <tbody>
          ...
          while ($rows = mysqli_fetch_array($query)) {
            ...
            if ($rows['status'] == "closed") {
              ...
              $stat = "<strong class='text-success'>Active</strong>";
            ...
            <tr>
              ...
              <td><button class="btn btn-primary btn-sm" data-toggle="modal"
                  data-target="#replyModal<?php echo $rows['id'] ?>">View</button>
                <?php echo $btn ?>
              </td>
            </tr>
                  ...
                  <form action="" method="post" id="sendForm<?php echo $rows['id'] ?>">
                    <div class="nk-chat-editor" style="border-color:black;">
                      <div class="nk-chat-editor-upload  ml-n1">
                        <a href="#" class="btn btn-round btn-primary btn-icon"><em
                            class="icon ni ni-plus-circle-fill"></em></a>
                      </div>
                      <div class="chatResult"></div>
                      <div class="nk-chat-editor-form">
                        <div class="form-control-wrap">
                          <input type="hidden" name="ticketid<?php echo $id ?>" id="ticketid<?php echo $id ?>"
                            value="<?php echo $ticket ?>">
                          <textarea name="reply<?php echo $id ?>" class="form-control form-control-simple no-resize"
                            rows="1" id="reply<?php echo $id ?>" placeholder="Type your message..."></textarea>
                        </div>
                      </div>
                      <ul class="nk-chat-editor-tools g-2">
                        <li>
                          <div class="sendResult<?php echo $rows['id'] ?>"></div>
                          <button class="btn btn-round btn-primary btn-icon sendMsg<?php echo $rows['id'] ?>"><em
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <strong>You are about to close this ticket, The user won't be able to add reply on it when it's
                    closed.</strong>
                </div>
                <div class="closeResult<?php echo $rows['id'] ?>"></div>
                <div class="modal-footer">
                  <form action="" method="post">
                    <input type="hidden" name="closeT<?php echo $id ?>" value="<?php echo $id ?>"
                      id="closeT<?php echo $id ?>">
                    <button type="submit" class="btn btn-primary btn-sm closeBtn<?php echo $rows['id'] ?>">Close
                      ticket</button>
          ...
          <div class="modal fade" tabindex="-1" id="reopen<?php echo $rows['id'] ?>">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <strong>You are about to reopen this ticket, The user will be able to add reply on it when it's
                    open.</strong>
                </div>
                <div class="reopenResult<?php echo $rows['id'] ?>"></div>
                <div class="modal-footer">
                  <form action="" method="post">
                    <input type="hidden" name="reopenT<?php echo $id ?>" value="<?php echo $id ?>"
                      id="reopenT<?php echo $id ?>">
                    <button type="submit" class="btn btn-primary btn-sm reopenBtn<?php echo $rows['id'] ?>">Reopen
                      ticket</button>
                    <button class="btn btn-danger btn-sm" data-dismiss="modal">Cancel</button>
                  </form>
                </div>
