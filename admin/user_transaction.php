                        ...
                        <tr class="nk-tb-item">
                            ...
                            <td class="nk-tb-col">
                                <div class="user-card">
                                    ...
                                    <div class="user-info">
                                        <span class="tb-lead"><?php echo $refNumber ?><span
                            ...
                            <td class="nk-tb-col tb-col-mb" data-order="35040.34">
                                <span class="tb-amount"><?php echo $amount ?><span
                            ...
                            <td class="nk-tb-col nk-tb-col-tools">
                                <ul class="nk-tb-actions gx-1">
                                    ...
                                    <li class="nk-tb-action-hidden">
                                        <form method="post" id="delete_form<?php echo $id ?>"
                                            action="../scripts/auth?action=delete_trx&id=<?php echo $id ?>&userid=<?php echo $_GET['id'] ?>">
                                            <button class="btn btn-trigger btn-icon" data-toggle="tooltip"
                                        ...
                                        <div class="drodown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <ul class="link-list-opt no-bdr">
                                                    <li><a href="user_profile?id=<?php echo $_GET['id'] ?>"><em
