...
<div class="nk-content">
	<?php if (empty($_GET['action'])) { ?>
		<div class="card card-bordered card-preview">
			...
			<div class="card-body">
				<strong>Bank details that was uploaded here will authomatically pop up when a user is adding a recipient for
					international Transfer. The criterion is user supplying an account number that matched with the already
					uploaded records. Therefore, if they failed to input an account number that matched with any record,
					input fields will prompt out for them to fill it manually.</strong>
				<hr>
				...
				<form action="../scripts/upload_bank.php" id="uploadForm">
					<div class="row card-bordered p-1" style="border-radius: 5px;">
						...
						<div class="form-group col-lg-6">
							<div class="form-control-wrap">
								<input type="text" placeholder="Account holder's name" name="accountname"
									class="form-control">
							</div>
						</div>
						<div class="form-group col-lg-6">
						...
						while ($rows = mysqli_fetch_array($query)) {
							...
							<tr>
								...
								<td><a class="btn btn-primary btn-sm"
										href="miscellaneous?action=edit&id=<?php echo $rows['id'] ?>"><em
			...
			<div class="card-body">
				...
				<form action="../scripts/update_bank.php" id="updateForm">
					<div class="row card-bordered p-1" style="border-radius: 5px;">
						<div class="form-group col-lg-6">
							<div class="form-control-wrap">
								<input type="text" name="accountnumber" value="<?php echo $rows['accountnumber'] ?>"
						...
						<div class="form-group col-lg-6">
							<div class="form-control-wrap">
								<input type="text" name="bankname" placeholder="Bank Name"
									value="<?php echo $rows['bankname'] ?>" class="form-control">
							</div>
						</div>
						<div class="form-group col-lg-6">
							<div class="form-control-wrap">
								<input type="text" placeholder="Account holder's name"
									value="<?php echo $rows['accountname'] ?>" name="accountname" class="form-control">
							</div>
						</div>
						...
						<div class="form-group col-lg-6">
							<div class="form-control-wrap">
								<input type="text" placeholder="Bank Branch Address"
									value="<?php echo $rows['bankbranch'] ?>" name="bankbranch" class="form-control">
							</div>
						</div>
						<div class="form-group col-lg-12">
							<div class="form-control-wrap">
								<input type="text" placeholder="Account type" value="<?php echo $rows['accounttype'] ?>"
