                ...
                <div class="nk-block-between-md g-4 card-bordered">
                    ...
                    <div class="nk-block-head-content">
                        <ul class="nk-block-tools gx-3">
                            <li><a href="open_user_account" class="btn btn-primary"><span>Open an account</span> <em
        ...
        ';
                            ...
                            <tr class="nk-tb-item">
                                ...
                                <td class="nk-tb-col tb-col-mb" data-order="35040.34">
                                    <span class="tb-amount"><?php echo $accountbalance ?> <span
                                            class="currency"><?php echo $money ?></span></span>
                                </td>
                                ...
                                <td class="nk-tb-col nk-tb-col-tools">
                                    <ul class="nk-tb-actions gx-1">
                                        <li class="nk-tb-action-hidden">
                                            <a href="fund_user?accountnumber=<?php echo $accountnumber ?>&id=<?php echo $userid ?>"
                                        ...
                                        <li class="nk-tb-action-hidden">
                                            <a href="email_user?email=<?php echo $email ?>" class="btn btn-trigger btn-icon"
                                            ...
                                            <div class="drodown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <ul class="link-list-opt no-bdr">
                                                        <li><a href="user_profile?id=<?php echo $userid ?>"><em
                                                                    class="icon ni ni-eye"></em><span>View
                                                                    Details</span></a></li>
                                                        <li><a href="user_transaction?id=<?php echo $userid ?>"><em
                                                                    class="icon ni ni-repeat"></em><span>Transaction</span></a>
                                                        </li>
                                                        <li><a href="user_activity?id=<?php echo $userid ?>"><em
                                                                    class="icon ni ni-activity-round"></em><span>Activities</span></a>
                                                        </li>
                                                        <li class="divider"></li>
                                                        <li><a href="user_password_reset?id=<?php echo $userid; ?>"><em
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <form action="" method="post">
                                            <input type="hidden" name="suspendTranfer<?php echo $userid ?>"
                                                value="<?php echo $userid ?>" id="suspendTranfer<?php echo $userid ?>">
                                            <button type="submit"
                                                class="btn btn-primary btn-sm closeBtn<?php echo $userid ?>">Suspend</button>
                        ...
                        <div class="modal fade" tabindex="-1" id="unblockTranfer<?php echo $userid ?>">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <form action="" method="post">
                                            <input type="hidden" name="unblockTranfer<?php echo $userid ?>"
                                                value="<?php echo $userid ?>" id="unblockTranfer<?php echo $userid ?>">
                                            <button type="submit"
                                                class="btn btn-primary btn-sm unblockTranferBtn<?php echo $userid ?>">Unblock</button>
                                            <button class="btn btn-danger btn-sm" data-dismiss="modal">Cancel</button>
                                        </form>
                                    </div>
                                </div>
                        ...
                        <div class="modal fade" tabindex="-1" id="suspendAccount<?php echo $userid ?>">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <strong>You are about to Suspend
                                            <?php echo $fullname ?> from the system. The user will be restricted from
                                            accessing his/her account if you proceed with this action.
                                        </strong>
                                    </div>
                                    <div class="suspendResult<?php echo $userid ?>"></div>
                                    <div class="modal-footer">
                                        <form action="" method="post">
                                            <input type="hidden" name="suspend<?php echo $userid ?>"
                                                value="<?php echo $userid ?>" id="suspend<?php echo $userid ?>">
                                            <button type="submit"
                                                class="btn btn-primary btn-sm suspendBtn<?php echo $userid ?>">Suspend</button>
                                            <button class="btn btn-danger btn-sm" data-dismiss="modal">Cancel</button>
                                        </form>
                                    </div>
                                </div>
                        ...
                        <div class="modal fade" tabindex="-1" id="unblockAccount<?php echo $userid ?>">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <strong>You are about to unblock
                                            <?php echo $fullname ?> whose account was currently restricted from the
                                            system. The user will be able to access his/her account onwards if you
                                    ...
                                    <div class="modal-footer">
                                        <form action="" method="post">
                                            <input type="hidden" name="unblock<?php echo $userid ?>"
                                                value="<?php echo $userid ?>" id="unblock<?php echo $userid ?>">
                                            <button type="submit"
                                                class="btn btn-primary btn-sm unblockBtn<?php echo $userid ?>">Unblock</button>
                                            <button class="btn btn-danger btn-sm" data-dismiss="modal">Cancel</button>
                                        </form>
                                    </div>
                                </div>
