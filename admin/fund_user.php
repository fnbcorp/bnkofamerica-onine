                ...
                <div class="buysell wide-xs m-auto">
                    <div class="buysell-nav text-center">
                        <ul class="nk-nav nav nav-tabs nav-tabs-s2">
                            ...
                            <li class="nav-item">
                                <a class="nav-link"
                                    href="debit_user?accountnumber=<?php echo $_GET['accountnumber'] ?>&id=<?php echo $_GET['id'] ?>">Debit
                                    Account</a>
                            </li>
                        </ul>
                    </div><!-- .buysell-nav -->
                        ...
                        <form action="" class="buysell-form" method="post">
                            ...
                            <div class="buysell-field form-group">
                                ...
                                <div class="buysell-field form-group">
                                    ...
                                    <div class="form-control-group">
                                        <select type="number" class="form-control form-control-lg form-control-number"
                                            id="scope" name="scope">
                            ...
                            <div class="buysell-field form-group">
                                ...
                                <div class="form-control-group">
                                    <input type="text" class="form-control form-control-lg form-control-number" id="memo"
                                        name="Memo" placeholder="the purpose of your transfer">
                                    <div class="form-dropdown">
                            ...
                            <div class="buysell-field form-group">
                                ...
                                <div class="form-control-group">
                                    <select type="text" class="form-control form-control-lg form-control-number"
