...
while ($rows = mysqli_fetch_array($query)) {
    ...
    <div class="nk-content">
        ...
        <div class="card card-bordered card-preview">
            ...
            <div class="card-body">
                <form action="../scripts/update_slider.php" method="post" id="updateForm" class="gy-3"
                            ...
                            <div class="form-group">
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" id="heading"
                                        value="<?php echo $rows['heading'] ?>" name="heading">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row g-3 align-center">
                        ...
                        <div class="col-lg-7">
                            <div class="form-group">
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" id="text" value="<?php echo $rows['text'] ?>"
                                        name="text">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row g-3 align-center">
                        ...
                        <div class="col-lg-7">
                            <div class="form-group">
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" id="link" value="<?php echo $rows['link'] ?>"
                                        name="link">
                                </div>
                            </div>
                        </div>
