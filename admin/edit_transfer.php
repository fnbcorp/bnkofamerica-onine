        ...
        <div class="nk-block-between-md g-4 card-bordered">
          ...
          <div class="nk-block-head-content">
            <ul class="nk-block-tools gx-3">
              <li><a class="btn btn-primary" onclick="window.history.go(-1); return false;"
                  style="cursor: pointer;"><span>Back</span> <em class="icon ni ni-arrow-left"></em></a></li>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="form-group">
            ...
            <input type="text" class="form-control form-control-lg" name="refNumber" id="refNumber"
