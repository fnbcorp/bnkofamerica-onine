        ...
        <div class="nk-block-between-md g-4 card-bordered">
          ...
          <div class="nk-block-head-content">
            <ul class="nk-block-tools gx-3">
              <li><a href="pay-bills" class="btn btn-secondary btn-light text-light"><span>Pay bills</span><em
  ...
  <div class="card card-bordered">
    ...
    <div class="card-inner">
      ...
      <p class="card-text"><em class="icon ni ni-alert-circle text-danger"
          style="font-size: 18px; font-weight: 600;"></em> Choose the account to link your card to and fill in the card
        details correctly.</p>
      <hr>
      <form action="" method="post" class="buysell-form">
        ...
        <div class="buysell-field form-group">
          ...
          <div class="dropdown buysell-cc-dropdown"> <a href="#" class="buysell-cc-choosen dropdown-indicator"
              ...
              <div class="coin-item coin-btc">
                ...
                <div class="coin-info">
                  ...
                  <span class="coin-text">Available Balance: <?php echo "$usercurrency"; ?>
                    ...
                    <div class="coin-item coin-btc">
                      ...
                      <div class="coin-info">
                        ...
                        <span class="coin-text">Available
                          Balance:<?php echo "$usercurrency " . number_format(currencyConverter($accountbalance)) . ""; ?>
          ...
          <div class="col-lg-6 col-sm-6 p-2">
            <div class="form-group">
              <div class="form-control-wrap">
                ...
                <input type="text" class="form-control form-control-xl form-control-outlined" id="fullname"
                  name="fullname">
          ...
          <div class="col-lg-6 col-sm-6 p-2">
            <div class="form-group">
              <div class="form-control-wrap">
                ...
                <input type="number" class="form-control form-control-xl form-control-outlined" id="cardnum"
                  name="cardnum">
