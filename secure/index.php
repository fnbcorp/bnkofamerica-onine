...
<body class="nk-body npc-crypto bg-white pg-auth">
            ...
            <div class="nk-split-content nk-block-area nk-block-area-column nk-auth-container bg-white">
                ...
                <div class="nk-block nk-block-middle nk-auth-body">
                    ...
                    <?php if (isset($_GET['action']) and $_GET['action'] == "verify") { ?>
                        <div class="nk-block-head">
                            <div class="nk-block-head-content">
                                ...
                                <div class="nk-block-des alert alert-pro alert-primary">
                                    <p class="alert-text">Let's make sure it's really you. We just sent a verification code
                                        to the email address that is associated with your <?php echo $sitename ?> account.
                                        Enter the 4 digits code below;</p>
                                </div>
                            </div>
                        </div><!-- .nk-block-head -->
                        <form action="../scripts/auth?action=userVerify2fa" id="2faForm" method="post">
                            <div class="form-group nk-feature-center">
                                <input id="codeBox1" name="codeBox1" type="number" maxlength="1"
                                    onkeyup="onKeyUpEvent(1, event)" onfocus="onFocusEvent(1)" />
                                <input id="codeBox2" name="codeBox2" type="number" maxlength="1"
                                    onkeyup="onKeyUpEvent(2, event)" onfocus="onFocusEvent(2)" />
                                <input id="codeBox3" name="codeBox3" type="number" maxlength="1"
                                    onkeyup="onKeyUpEvent(3, event)" onfocus="onFocusEvent(3)" />
                                <input id="codeBox4" name="codeBox4" type="number" maxlength="1"
                        ...
                        <center class="p-3">
                            <a href="../personal-banking/logout" class="btn btn-sm btn-secondary"><em
                                    class="icon ni ni-delete"></em>Cancel</a>
                        </center>
                        <!------------Password Reset--------->
                    ...
                    <div class="nk-block-head">
                        <div class="nk-block-head-content">
                            ...
                            <div class="nk-block-des alert alert-pro alert-primary">
                                <p class="alert-text">Kindly provide your
                                    <?php echo $sitename ?> account number.
                                </p>
                            </div>
                        </div>
                    </div><!-- .nk-block-head -->
                        <form action="../scripts/auth?action=userPassReset" id="resetForm" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-lg" autocomplete="off" id="id"
                                    placeholder="Enter your Account Number" name="id" required>
                            </div><!-- foem-group -->
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <button class="btn btn-lg btn-primary btn-block secretFordm" type="submit"
                                    id="btn">Continue</button>
                            </div>
                        </form><!-- form -->
                        <center class="p-3">
                            <a href="index?action=enroll&access=<?php echo $_SESSION['accessBanking'] ?>"
                                class="btn btn-sm btn-secondary"><em class="icon ni ni-regen"></em> Enroll for Online
                                Banking</a>
                        </center>
                        <center class="p-3">
                            <a href="index" class="btn btn-sm btn-default"><em class="icon ni ni-forward-ios"></em>
                                Login</a>
                        </center>
                    ...
                    <?php } elseif (isset($_GET['action']) and $_GET['action'] == "resetPass") {
                        ...
                        <div class="nk-block-head">
                            <div class="nk-block-head-content">
                                ...
                                <div class="nk-block-des alert alert-pro alert-primary">
                                    <p class="alert-text">Accurately fill in the form below to change your account password.
                                    </p>
                                </div>
                            </div>
                        </div><!-- .nk-block-head -->
                        <form
                            action="../scripts/auth?action=userPassResetConfirm&token=<?php echo $token ?>&code=<?php echo $captcha ?>"
                            id="resetFormConfirm" method="post">
                            <div class="form-group">
                                <div class="form-control-wrap">
                                    ...
                                    <input type="password" required class="form-control form-control-lg" id="npassword"
                            ...
                            <div class="form-group">
                                <div class="form-control-wrap">
                                    <a tabindex="-1" href="#" class="form-icon form-icon-right passcode-switch"
                                        data-target="cnpassword">
                                        <em class="passcode-icon icon-show icon ni ni-eye"></em>
                                        <em class="passcode-icon icon-hide icon ni ni-eye-off"></em>
                                    </a>
                                    <input type="password" required class="form-control form-control-lg" id="cnpassword"
                                        placeholder="Confirm password" name="cnpassword">
                                </div>
                            </div>
                            <div class="form-group">
                                <link href="https://fonts.googleapis.com/css?family=Henny+Penny&display=swap"
                            ...
                            <div class="form-group">
                                <button class="btn btn-lg btn-primary btn-block" type="submit" id="btn">Change
                                    password</button>
                            </div>
                        </form><!-- form -->
                        <center class="p-3">
                            <a href="index" class="btn btn-sm btn-secondary"><em class="icon ni ni-forward-ios"></em>
                                Login</a>
                        </center>
                    ...
                    <?php } elseif (isset($_GET['action']) and $_GET['action'] == "enroll") { ?>
                        ...
                        <div class="nk-block-head">
                            <div class="nk-block-head-content">
                                ...
                                <div class="nk-block-des alert alert-pro alert-primary">
                                    <p class="alert-text">Before you continue, Kindly read and accept our terms and
                                        conditions.</p>
                                </div>
                            </div>
                        </div><!-- .nk-block-head -->
 ...
 width:100%; padding: 10px; font-size:16px;" autocomplete="off">
    ...
    <?php echo $sitename ?> service is available to you if you are 18 years of age or over.
                            ...
                            <br><br>
                            <button id="btn1" class="btn btn-secondary"><a href="index"
                                    style="color:white;">Decline</a></button>&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
                            &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                            <button id="btn1" class="btn btn-primary"><a href="register?tc=1" style="color:white;">I
                                    Accept</a></button>
                        </form><!-- form -->
                    ...
                    <?php } else { ?>
                        ...
                        <div class="nk-block-head">
                            <div class="nk-block-head-content">
                                ...
                                <div class="nk-block-des alert alert-pro alert-primary">
                                    <p class="alert-text">Access the <?php echo $sitename ?> online banking panel using your
                        ...
                        <form action="../scripts/auth?action=userLogin" id="loginForm" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-lg" required autocomplete="off" id="id"
                                    placeholder="Enter your Account Number" name="id">
                            </div><!-- foem-group -->
                            <div class="form-group">
                                <div class="form-label-group">
                                    <label class="form-label" for="password">Passsword</label>
                                    <a class="link link-primary link-sm" tabindex="-1"
                                        href="index?action=resetpass&access=<?php echo $_SESSION['accessBanking'] ?>">Forgot
                                        Code?</a>
                                </div>
                                <div class="form-control-wrap">
                                    <a tabindex="-1" href="#" class="form-icon form-icon-right passcode-switch"
                        ...
                        <div class="slider-item">
                            <div class="nk-feature nk-feature-center">
                                <div class="nk-feature-img">
                                    <img class="round" src="../images/security.svg" srcset="../images/security.svg 2x"
                                        alt="">
                                </div>
