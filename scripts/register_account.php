...
if ($errorMsg == 0) {
  ...
  $query = $conn->query("INSERT INTO users (username, firstname, lastname, middlename, state, country, city, zipcode, dob, address, phone, email, accountnumber, accounttype, usercurrency, accountbalance, imf, cot, secretCode, password, approve, status, datecreated, gender, passport, securityquestion, answer, ssn, maidensname, title, dayOFBirth, monthOfBirth, yearOfBirth, occupation, income, nextOfKIn, nickname, tfa, next_address, next_relationship, next_age, securityquestion2, answer2, email_verify, email_code, blocktransfer, allowtransfer)
  VALUES ('$email', '$firstname', '$lastname', '$middlename', '$state', '$country', '$city', '$zipcode', '$dob', '$address', '$phone', '$email', '$accountnumber', '$accounttype', '$usercurrency', '$accountbalance', '$imf', '$cot', '$secretCode', '$pass', '1', 'active', '$dated', '', '', '', '', 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0,'', 1, 1)");
  // $query = $conn->query("INSERT INTO users (username, firstname, lastname, middlename, state, country, city, zipcode, dob, address, phone, email, accountnumber, accounttype, usercurrency, accountbalance, imf, cot, secretCode, password, approve, status, datecreated, gender, passport) VALUES ('$email', '$firstname', '$middlename', '$lastname', '$state', '$country', '$city', '$zipcode', '$dob', '$address', '$phone', '$email', '$accountnumber', '$accounttype', '$usercurrency', '$accountbalance', '$imf', '$cot', '$secretCode', '$pass', '1', 'active', '$dated', '', '')");
